...
public class FileEncodeUtils extends Encoding {

  /**
  * Singleton
  */
  public static FileEncodeUtils getInstance(){
    return Singleton.get(FileEncodeUtils.class);
  }
  public static String getJavaEncode(File file) {
    FileEncodeUtils instance = getInstance();
  ...
  public static String getJavaEncode(InputStream inputStream) {
    ...
    FileEncodeUtils instance = getInstance();
    return instance.javaname[getInstance().detectEncoding(bytes)];
  }
