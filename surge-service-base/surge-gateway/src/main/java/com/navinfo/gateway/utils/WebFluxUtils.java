package com.surge.gateway.utils;
...
import com.surge.gateway.filter.GlobalCacheRequestFilter;
...
public class WebFluxUtils {
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, HttpStatus httpStatus, R result) {
        return webFluxResponseWriter(response, httpStatus, result.getData(), result.getCode());
    }
